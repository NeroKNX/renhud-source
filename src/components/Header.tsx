    ...
    <header className="px-2 sm:px-4 md:px-6 py-3 md:py-4 border-b border-[#252942] bg-[#0a0d14] flex items-center justify-between gap-2 sm:gap-4">
      ...
      <div className="flex items-center gap-2 sm:gap-3 min-w-0">
        ...
        <div className="min-w-0">
          ...
          <span className="inline-flex items-center gap-1 text-[9px] sm:text-[10px] px-1.5 sm:px-2 py-0.5 bg-[#4f46e5]/10 text-[#818cf8]/90 border border-[#4f46e5]/30 rounded font-mono">
