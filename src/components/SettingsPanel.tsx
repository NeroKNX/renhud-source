...
export function SettingsPanel({ isOpen, onClose, isConnected }: SettingsPanelProps) {
  const [fontSize, setFontSize] = useState<FontSize>(() => {
    return (localStorage.getItem('ren_font_size') as FontSize) || 'medium';
  });
  const [theme, setTheme] = useState<Theme>(() => {
    return (localStorage.getItem('ren_theme') as Theme) || 'dark';
  });
  ...
  const handleFontSize = (size: FontSize) => {
    setFontSize(size);
    localStorage.setItem('ren_font_size', size);
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 w-80 md:w-96 bg-[#16192a] border-l border-[#252942] z-50 flex flex-col shadow-[0_0_50px_rgba(0,0,0,0.5)]"
          >
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6">
              ...
              <div className="border-t border-[#252942]" />
